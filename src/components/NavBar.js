...
const NavBar = () => {
  ...
  return (
    <nav
      className={`px-12 xl:px-80 lg:px-48 md:px-28 sm:px-12 flex h-24 flex-grow fixed left-0 right-0 transition-all duration-150 delay-100 backdrop-filter backdrop-blur shadow-lg ${
